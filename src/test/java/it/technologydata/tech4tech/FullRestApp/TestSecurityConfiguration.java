...
import it.technologydata.tech4tech.FullRestApp.security.MyAccessDeniedHandler;
import it.technologydata.tech4tech.FullRestApp.security.MyBasicAuthenticationEntryPoint;
...
public class TestSecurityConfiguration {
	...
	@Bean
	@Order(1)
    public SecurityFilterChain employeeeSecurityfilterChain(HttpSecurity http) throws Exception {
        return http
    ...
    //Creating new AuthenticationProvider based on custom UserDetailsService and password encoder
	@Bean
